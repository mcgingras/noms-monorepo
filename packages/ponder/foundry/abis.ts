...
export const nomAbi = [
  ...
  },
  {
    ...
    inputs: [
      { name: 'to', internalType: 'address', type: 'address' },
      { name: 'traitTokenIds', internalType: 'uint256[]', type: 'uint256[]' },
      { name: 'quantities', internalType: 'uint256[]', type: 'uint256[]' },
      { name: 'prices', internalType: 'uint256[]', type: 'uint256[]' },
    ],
    name: 'mintAndInitialize',
    outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    stateMutability: 'payable',
  },
  {
...
export const nomTraitsAbi = [
  {
    type: 'constructor',
    inputs: [{ name: '_easel', internalType: 'address', type: 'address' }],
    stateMutability: 'nonpayable',
  },
  {
    type: 'function',
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'traitIds', internalType: 'uint256[]', type: 'uint256[]' },
      { name: 'quantities', internalType: 'uint256[]', type: 'uint256[]' },
      { name: 'prices', internalType: 'uint256[]', type: 'uint256[]' },
    ],
    name: 'batchMintViaModules',
    outputs: [{ name: '', internalType: 'bool', type: 'bool' }],
    stateMutability: 'payable',
  },
  {
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'description', internalType: 'string', type: 'string' },
      { name: 'creator', internalType: 'address', type: 'address' },
      { name: 'mintModule', internalType: 'address', type: 'address' },
    ],
    name: 'registerTraitWithMintModule',
    outputs: [],
    stateMutability: 'nonpayable',
  },
  {
